...
#' sheets found in a specified folder. When `choose.methods = "qPCR" or "metabarcoding"`
...
read_data <- function(choose.method, path.folder) {
  ...
  choose.method <- switch(choose.method,
    method$values[method$labels == choose.method]
  )
