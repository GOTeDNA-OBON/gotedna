...
#' @param newP_yr (required, list) detection probabilities aggregated per year
#' [calc_det_prob()].
#'
...
#'  newP_yr = newprob$newP_yr)
#' }
scale_prob_by_year <- function(data, ecodistrict.select, newP_yr) {
