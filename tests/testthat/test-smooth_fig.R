test_that("smooth_fig returns a ggplot2 object", {
  ...
  p <- smooth_fig(data = D_mb, species.name = "Acartia longiremis",
  ...
  expect_error(smooth_fig(data = D_mb, species.name = "A. longiremis",
                          primer.select = "COI1", ecodistrict.select = "Scotian Shelf"),
               "Species not found in data")
  expect_error(smooth_fig(data = D_mb, species.name = "Acartia longiremis",
  ...
  expect_warning(smooth_fig(data = D_mb, species.name = "Acartia longiremis",
                            primer.select = "COI1", ecodistrict.select = "Scotian Shelf"),
