test_that("higher_tax_fig returns a ggplot2 object", {
  ...
  p <- higher_tax_fig(data = D_mb, higher.taxon.select = "phylum", taxon.name = "Bryozoa",
                      view.by.level = "genus", ecodistrict.select = "Scotian Shelf",
                      primer.select = "COI1")


  expect_s3_class(p$layers[[1]]$geom, "GeomPoint")
  expect_error(higher_tax_fig(data = D_mb, higher.taxon.select = "phylum", taxon.name = "Bryozoa",
                              view.by.level = "genus", ecodistrict.select = "Scotian Shelf",
                              primer.select = "COI"),
  ...
  expect_error(higher_tax_fig(data = D_mb, higher.taxon.select = "phylum", taxon.name = "Bryo",
                              view.by.level = "genus", ecodistrict.select = "Scotian Shelf",
                              primer.select = "COI1"),
