...
$(function(){
  ...
  Shiny.addCustomMessageHandler('openFloating', function(message){
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          plotOutput(ns("monthly_circular_plot"), height = "220px", width = "100%")
        ),
          ...
          div(
            ...
            div(
              ...
              div(
                ...
                actionButton(ns("total_fish"),     "Fishes",        class = "btn btn-default filter-btn"),
                actionButton(ns("total_sharks"),   "Sharks & Rays", class = "btn btn-default filter-btn"),
                actionButton(ns("total_mammals"),  "Mammals",       class = "btn btn-default filter-btn"),
                actionButton(ns("total_reptiles"), "Turtles",      class = "btn btn-default filter-btn")
              ),
              ...
              div(
                class = "filter-btn-grid-4",
                actionButton(ns("total_birds"),      "Birds",       class = "btn btn-default filter-btn"),
                actionButton(ns("total_molluscs"),   "Molluscs",    class = "btn btn-default filter-btn"),
                actionButton(ns("total_arthropods"), "Arthropods",  class = "btn btn-default filter-btn"),
                actionButton(ns("total_plants"),     "Plants",      class = "btn btn-default filter-btn")
              ),
              ...
              div(
                ...
                actionButton(ns("SARA"), "SARA", class = "btn btn-default filter-btn filter-btn-short"),
                actionButton(ns("AIS"),  "AIS",  class = "btn btn-default filter-btn filter-btn-short")
              ),

              hr(),
              h4("Species List"),
              uiOutput(ns("species_panel"))
            )
          )
        )
      )
    ...
    div(
      ...
      tabsetPanel(
        tabPanel("Detection Details",              DT::DTOutput(ns("detections_tbl"))),
        tabPanel("Species at Risk Act (SARA): Schedule 1 Details", DT::DTOutput(ns("sara_details"))),
        tabPanel("Aquatic Invasive Species (AIS) Details",             DT::DTOutput(ns("ais_details")))
      )
    ),
      ...
      div(
        ...
        div(
          ...
          div(
            ...
            actionButton(ns("div_primer_all"), "Select all", class = "btn btn-default btn-sm"),
            actionButton(ns("div_primer_none"), "Deselect all", class = "btn btn-default btn-sm")
          )
        ),
        div(
          ...
          div(
            ...
            textOutput(ns("download_hint"), inline = TRUE)
          )
        )
      )
    ),
    ...
    fluidRow(
      column(
        ...
        shinycssloaders::withSpinner(
          plotly::plotlyOutput(ns("alpha_boxplot"), height = "700px"),
          type = 4
        )
      )
    ),
    ...
    fluidRow(
      column(
        ...
        offset = 2,
        shinycssloaders::withSpinner(
          plotly::plotlyOutput(ns("beta_pcoa"), height = "700px"),
          type = 4
        )
      )
    ),
    ...
    div(
      ...
      shinycssloaders::withSpinner(
        taxplore::KronaChartOutput(ns("tax_krona"), height = "700px"),
        type = 4
      )
    )
  )
